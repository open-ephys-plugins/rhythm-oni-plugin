...
namespace RhythmNode
{
	...
	public:
		...
		EventListener(RHD2000Thread* board_);
		~EventListener();
		...
		StreamingSocket baseSocket;

		ScopedPointer<StreamingSocket> connectedSocket;
	...
	public:
		RHD2000Thread(SourceNode* sn, BoardType boardType);
		~RHD2000Thread();
